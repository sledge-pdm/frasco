...
export class LinePreviewInstrument implements GripInstrument {
  ...
  private beginStroke(layer: Layer): void {
    ...
    layer.copyTextureRegion(this.baseTexture, { x: 0, y: 0, width: size.width, height: size.height });
  }
  ...
  // baseTexture is captured once at stroke start to keep a stable preview baseline.
}
